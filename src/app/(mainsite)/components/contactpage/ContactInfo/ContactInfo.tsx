 ...
 <div className={styles.contactInfo}>
    ...
    <div className={styles.info}>
        ...
        <div className={styles.info}>
            ...
            <div className={styles.textInfo}>
                <h2>Socials</h2>
                <a className={styles.socialIcon} target='_blank' href={`https://www.facebook.com/profile.php?id=61563961165470`}>
                ...
                <a className={styles.socialIcon} target='_blank' href={`https://maps.app.goo.gl/zMW6LKcCgosr9mHz7`}>
