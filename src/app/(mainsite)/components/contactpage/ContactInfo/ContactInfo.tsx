 ...
 <div className={styles.contactInfo}>
    ...
    <div className={styles.info}>
        ...
        <div className={styles.info}>
            ...
            <div className={styles.textInfo}>
                <h2>Socials</h2>
                <a className={styles.socialIcon} target='_blank' href={`https://www.facebook.com/profile.php?id=61555123734016`}>
                ...
                <a className={styles.socialIcon} target='_blank' href={`https://g.page/r/CYRhJiMGpatxEBM`}>
