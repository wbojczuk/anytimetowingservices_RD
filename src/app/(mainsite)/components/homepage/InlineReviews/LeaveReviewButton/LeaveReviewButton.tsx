 ...
 function toggleReviewMenu(){
  ...
  return (
    <div style={{display: (reviewKeys.length > 1) ? "inline-block": "none"}} id="leaveReviewButtonWrapper">
      <button style={{marginRight: 0}} className=" review-button-part main-link" onClick={(reviewKeys.length < 1) ? singleMediaRedirect : toggleReviewMenu} id="leaveReviewButton">
      Leave a Review!
          </button>
